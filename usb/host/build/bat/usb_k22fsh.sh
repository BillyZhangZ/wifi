...
cp -f "${ROOTDIR}/usb/host/source/classes/bluetooth/usb_host_bluetooth.h" "${OUTPUTDIR}/usb_host_bluetooth.h"
cp -f "${ROOTDIR}/usb/host/source/classes/video/usb_host_video.h" "${OUTPUTDIR}/usb_host_video.h"
...
cp -f "${ROOTDIR}/usb/host/source/classes/aoap/usb_host_aoa.h" "${OUTPUTDIR}/usb_host_aoa.h"
