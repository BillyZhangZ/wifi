...
copy "%ROOTDIR%\usb\host\source\classes\bluetooth\usb_host_bluetooth.h" "%OUTPUTDIR%\usb_host_bluetooth.h"/Y
...
copy "%ROOTDIR%\usb\host\source\classes\aoap\usb_host_aoa.h" "%OUTPUTDIR%\usb_host_aoa.h"/Y
