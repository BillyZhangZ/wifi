...
*
*END*********************************************************************/
static _mqx_int sgtl_Init(void)
{
    uint32_t param;
...
static _mqx_int sgtl_DeInit(void){
...
*
*END*********************************************************************/
static _mqx_int sgtl_WriteReg(uint16_t reg, uint16_t reg_val)
{
    uint8_t buffer[4];
    uint32_t result;
...
*
*END*********************************************************************/
static _mqx_int sgtl_ReadReg(uint16_t reg, uint16_t *dest_ptr)
{
    uint8_t buffer[2];
...
*
*END*********************************************************************/
static _mqx_int sgtl_ModifyReg(uint16_t reg, uint16_t clr_mask, uint16_t set_mask)
{
    uint16_t reg_val = 0;
...
_mqx_int CodecInit()
{
    ...
    /************************************************************************/
    /* Mask this, not sure, need confirmed!, if not mask, noise arise when it 
     * be called, */
    /************************************************************************/
#if 0
