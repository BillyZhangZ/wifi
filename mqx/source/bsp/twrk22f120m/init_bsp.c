...
int _bsp_init(void) {
    ...
    _kuart_int_install("ittya:", &_bsp_sci0_init, _bsp_sci0_init.QUEUE_SIZE, _bsp_sci0_init.QUEUE_SIZE);
#endif
    ...
    _kuart_int_install("ittyc:", &_bsp_sci2_init, _bsp_sci2_init.QUEUE_SIZE, _bsp_sci2_init.QUEUE_SIZE);
#endif
