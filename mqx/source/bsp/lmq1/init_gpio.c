...
)
{
    ...
    switch (dev_num)
    {
        case 0:
            ...
            {
                /* PTA15 as RX function (Alt.2) + drive strength */
...
)
{
    switch(dev_num)
    {
        case 0:
            ...
            PORTC_PCR2 |= PORT_PCR_MUX(0x06);                  /* Configure Port for TX Bit Clock */
            /* GPIO for TX SSI0_FS */
            PORTC_PCR3 |= PORT_PCR_MUX(0x06);                  /* Configure port for TX Frame Sync*/
