...
//#define BSP_SW1                     (GPIO_PORT_C | GPIO_PIN6)   /* not used  */
...
//#define BSP_SW1_MUX_GPIO            (LWGPIO_MUX_C6_GPIO)   /* not used  */
...
#define BSP_I2C0_ADDRESS                    (0x20)                 /* AAA CHIP   */
#define BSP_I2C1_ADDRESS                    (0x6F)                 /* To be done */
...
#define BSP_ATHEROS_WIFI_GPIO_INT_PIN                   (GPIO_PORT_C|GPIO_PIN_IRQ_FALLING|GPIO_PIN9)  /*!TODO  need confirm this GPIO pin later !*/

#define BSP_ATHEROS_WIFI_GPIO_PWD_DEVICE                "gpio:write"
#define BSP_ATHEROS_WIFI_GPIO_PWD_PIN                   (GPIO_PORT_C|GPIO_PIN11) /*!TODO  need confirm this GPIO pin later !*/
