...
*/
//#define BSP_LED1                    (GPIO_PORT_B | GPIO_PIN17)  /* LCM pin34 */

//#define BSP_LED2                    (GPIO_PORT_B | GPIO_PIN18)  /* LCM pin35 */
//#define BSP_LED3                    (GPIO_PORT_B | GPIO_PIN19)  /* LCM pin36 */

//#define BSP_LED4                    (GPIO_PORT_D | GPIO_PIN7)   /* not used  */

//#define BSP_SW1                       (GPIO_PORT_A | GPIO_PIN3)   
//#define BSP_SW2                     (GPIO_PORT_C | GPIO_PIN7)   /* not used  */

//#define BSP_ACCEL_IRQ               (GPIO_PORT_B | GPIO_PIN0) /* onboard accelerometer IRQ pin */ /* not used  */

//#define BSP_LED1_MUX_GPIO           (LWGPIO_MUX_B17_GPIO)
//#define BSP_LED2_MUX_GPIO           (LWGPIO_MUX_B18_GPIO)
//#define BSP_LED3_MUX_GPIO           (LWGPIO_MUX_B19_GPIO)
//
//#define BSP_LED4_MUX_GPIO           (LWGPIO_MUX_D7_GPIO)   /* not used  */
#define BSP_SW1_MUX_GPIO              (LWGPIO_MUX_A3_GPIO)   
//#define BSP_SW2_MUX_GPIO            (LWGPIO_MUX_C7_GPIO)   /* not used  */
//#define BSP_ACCEL_MUX_GPIO          (LWGPIO_MUX_B0_GPIO)   /* not used  */

/* definitions for user applications */
//#define BSP_BUTTON1                 BSP_SW1 /* not used  */
//#define BSP_BUTTON2                 BSP_SW2 /* not used  */

//#define BSP_BUTTON1_MUX_GPIO        BSP_SW1_MUX_GPIO  /* not used  */
//#define BSP_BUTTON2_MUX_GPIO        BSP_SW2_MUX_GPIO  /* not used  */
//#define BSP_BUTTON1_MUX_IRQ         BSP_SW1_MUX_GPIO  /* not used  */
//#define BSP_BUTTON2_MUX_IRQ         BSP_SW2_MUX_GPIO  /* not used  */

//#define BSP_BUTTON1_GPIO_INT        (GPIO_PORT_C|GPIO_PIN_IRQ_FALLING|GPIO_PIN6) /* not used  */
//#define BSP_BUTTON2_GPIO_INT        (GPIO_PORT_C|GPIO_PIN_IRQ_FALLING|GPIO_PIN7) /* not used  */
...
#define SDCARD_SPI_FAST_CRC 1

#define BSP_SDCARD_SPI_CHANNEL                        "spi1:"
#define BSP_SDCARD_SPI_CS                             0x01
#define BSP_SDCARD_GPIO_DETECT                        (GPIO_PORT_A | GPIO_PIN5)
//#define BSP_SDCARD_GPIO_PROTECT                       (GPIO_PORT_A | GPIO_PIN17)
#define BSP_SDCARD_DETECT_MUX_GPIO                    (LWGPIO_MUX_A5_GPIO)
//#define BSP_SDCARD_PROTECT_MUX_GPIO                   (LWGPIO_MUX_A17_GPIO)
//#define BSP_SDCARD_CS_MUX_GPIO                        (LWGPIO_MUX_D7_GPIO)

#define BSP_SDCARD_CS_74HC595                         (1 << BSP_74HC595_SPI_S0)

/*-----------------------------------------------------------------------------
**                      I2C
*/
#define BSP_I2C_CLOCK                       (BSP_BUS_CLOCK)
#define BSP_I2C0_ADDRESS                    (0x20)                 /* !TODO    */
#define BSP_I2C1_ADDRESS                    (0x20)                 /* AAA CHIP */
...
#define BSP_74HC595_0                                    0  /* index */
#define BSP_74HC595_0_COUNT                              2  /* count */


#define BSP_74HC595_SHCP                                 (GPIO_PORT_C | GPIO_PIN7)
#define BSP_74HC595_SHCP_MUX_GPIO                        (LWGPIO_MUX_C7_GPIO)

#define BSP_74HC595_STCP                                 (GPIO_PORT_B | GPIO_PIN3)
#define BSP_74HC595_STCP_MUX_GPIO                        (LWGPIO_MUX_B3_GPIO)

#define BSP_74HC595_DS                                   (GPIO_PORT_B | GPIO_PIN2)
#define BSP_74HC595_DS_MUX_GPIO                          (LWGPIO_MUX_B2_GPIO)


#define BSP_74HC595_SPI_S1                               15
#define BSP_74HC595_SPI_S0                               14
#define BSP_74HC595_VBLE_3V3                             13
#define BSP_74HC595_VIR_RCV_3V3                          12
#define BSP_74HC595_BLT_PWREN                            11
#define BSP_74HC595_RELAY_CTRL                           10
#define BSP_74HC595_GPIO                                 9
#define BSP_74HC595_AUD_LDO1_EN                          8
#define BSP_74HC595_AMB_LED                              7
#define BSP_74HC595_GPIO_HOST_EN                         6
#define BSP_74HC595_5V_PWREN                             5
#define BSP_74HC595_LCD_nRST                             4
#define BSP_74HC595_LCD_PWREN                            3
#define BSP_74HC595_AUD_PWREN                            2
#define BSP_74HC595_BT_PWREN                             1
#define BSP_74HC595_BLE_RST                              0
...
#define BSP_DUART0_DMA_RX_CHANNEL        (4)
#define BSP_DUART0_DMA_TX_CHANNEL        (5)
#define BSP_DUART1_DMA_RX_CHANNEL        (6)
#define BSP_DUART1_DMA_TX_CHANNEL        (7)
#define BSP_DUART2_DMA_RX_CHANNEL        (8)
#define BSP_DUART2_DMA_TX_CHANNEL        (9)
/*-----------------------------------------------------------------------------*/
/*
...
#define BSP_SPI_CS                                  0
 ...
 /* gpio file mode, need not pin mux config ? */
#define BSP_ATHEROS_WIFI_GPIO_INT_DEVICE                "gpio:input"
#define BSP_ATHEROS_WIFI_GPIO_INT_PIN                   (GPIO_PORT_C|GPIO_PIN_IRQ_FALLING|GPIO_PIN11)  /* WIFI module V2 */
//#define BSP_ATHEROS_WIFI_GPIO_INT_PIN                   (GPIO_PORT_C|GPIO_PIN_IRQ_FALLING|GPIO_PIN9)  /* WIFI module V1  */

#define BSP_ATHEROS_WIFI_GPIO_PWD_DEVICE                "gpio:write"
#define BSP_ATHEROS_WIFI_GPIO_PWD_PIN                   (GPIO_PORT_C|GPIO_PIN10) /* WIFI module V2 */
//#define BSP_ATHEROS_WIFI_GPIO_PWD_PIN                   (GPIO_PORT_C|GPIO_PIN0) /* WIFI module V1 */

/* Just LED ? for FET ? but now we not use this pin */
//#define BSP_ATHEROS_WIFI_GPIO_FET_PIN                   (GPIO_PORT_B|GPIO_PIN10)/*!TODO  need fix this GPIO pin later !*/
...
#ifndef BSPCFG_SCI1_OQUEUE_SIZE
    #define BSPCFG_SCI1_OQUEUE_SIZE            64
#endif

#ifndef BSPCFG_SCI1_IQUEUE_SIZE
    #define BSPCFG_SCI1_IQUEUE_SIZE           8192
#endif
/** MGCT: </category> */
