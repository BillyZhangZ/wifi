...
#endif
   ,
   BSP_DUART0_DMA_TX_CHANNEL,
   BSP_DUART0_DMA_RX_CHANNEL,
};
...
#endif
   ,
   BSP_DUART1_DMA_TX_CHANNEL,
   BSP_DUART1_DMA_RX_CHANNEL,
   BSPCFG_SCI1_OQUEUE_SIZE,
   BSPCFG_SCI1_IQUEUE_SIZE,
};
...
#endif
   ,
   BSP_DUART2_DMA_TX_CHANNEL,
   BSP_DUART2_DMA_RX_CHANNEL,
};
