...
int _bsp_init(void) {
...
#if BSPCFG_ENABLE_DTTYA
    _kuart_dma_install("dttya:", &_bsp_sci0_init, _bsp_sci0_init.QUEUE_SIZE);
#endif
    ...
    _kuart_int_install("ittyb:", &_bsp_sci1_init, _bsp_sci1_init.QUEUE_SIZE, _bsp_sci1_init.QUEUE_SIZE);
#endif

#if BSPCFG_ENABLE_DTTYB
    _kuart_dma_install("dttyb:", &_bsp_sci1_init, _bsp_sci1_init.QUEUE_SIZE, _bsp_sci1_init.QUEUE_SIZE);
#endif

#if BSPCFG_ENABLE_MTTYB
    _kuart_mix_install("mttyb:", &_bsp_sci1_init, _bsp_sci1_init.OQUEUE_SIZE, _bsp_sci1_init.IQUEUE_SIZE);
#endif
    ...
    mux_74hc595_init(BSP_74HC595_0, BSP_74HC595_0_COUNT,
