...
KSAI_INIT_STRUCT _bsp_ksai_init = {
    ...
    16,                     /* Data bits */
#if (BSPCFG_SAI_CLK_SOURCE_FROM_PLL_OUT)
    I2S_CLK_INT3,           /* Clock source */
#else
    I2S_CLK_INT0,           /* Clock source */
#endif
    FALSE,                  /* Tx Dummy */
    ...
    CM_CLOCK_SOURCE_USB,    /* Internal IRC48M clock source */
#else
    CM_CLOCK_SOURCE_PLLFLL, /* Internal PLLFLL clock source */
#endif
#else
