...
{ /* Body */
   ...
   int_io_dev_ptr->IN_QUEUE = (void *)_mem_alloc_system(
      sizeof(CHARQ_STRUCT) - (4 * sizeof(char)) + int_io_dev_ptr->IQUEUE_SIZE);
   ...
   _CHARQ_INIT(int_io_dev_ptr->IN_QUEUE, int_io_dev_ptr->IQUEUE_SIZE);
   _CHARQ_INIT(int_io_dev_ptr->OUT_QUEUE, int_io_dev_ptr->OQUEUE_SIZE);
   int_io_dev_ptr->INPUT_HIGH_WATER_MARK = int_io_dev_ptr->IQUEUE_SIZE -
      int_io_dev_ptr->IQUEUE_SIZE / 8;
   int_io_dev_ptr->INPUT_LOW_WATER_MARK  = int_io_dev_ptr->IQUEUE_SIZE / 2;
