...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
cp -f "${ROOTDIR}/mqx/source/io/sai/int/sai_int_prv.h" "${OUTPUTDIR}/sai_int_prv.h"
cp -f "${ROOTDIR}/config/twrk22_qca4002/user_config.h" "${OUTPUTDIR}/../user_config.h"
cp -f "${ROOTDIR}/mqx/source/io/hwtimer/hwtimer_lpt.h" "${OUTPUTDIR}/hwtimer_lpt.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/twrk22_qca4002.h" "${OUTPUTDIR}/twrk22_qca4002.h"
cp -f "${ROOTDIR}/mqx/source/io/debug/iodebug.h" "${OUTPUTDIR}/iodebug.h"
cp -f "${ROOTDIR}/mqx/source/include/mqx.h" "${OUTPUTDIR}/mqx.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/bsp.h" "${OUTPUTDIR}/bsp.h"
cp -f "${ROOTDIR}/mqx/source/io/adc/kadc/adc_mk22f.h" "${OUTPUTDIR}/adc_mk22f.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
cp -f "${ROOTDIR}/mqx/source/io/flashx/freescale/flash_ftfa.h" "${OUTPUTDIR}/flash_ftfa.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
cp -f "${ROOTDIR}/mqx/source/io/flashx/freescale/flash_mk22.h" "${OUTPUTDIR}/flash_mk22.h"
...
cp -f "${ROOTDIR}/mqx/source/io/rnga/rnga.h" "${OUTPUTDIR}/rnga.h"
...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/iar/intflash.icf" "${OUTPUTDIR}/intflash.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
mkdir -p "${OUTPUTDIR}/Generated_Code"
...
if [ "${TOOL}" = "uv4" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/uv4/intflash.scf" "${OUTPUTDIR}/intflash.scf"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22_qca4002/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
