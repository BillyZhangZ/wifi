...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
cp -f "${ROOTDIR}/mqx/source/io/sai/int/sai_int_prv.h" "${OUTPUTDIR}/sai_int_prv.h"
cp -f "${ROOTDIR}/config/twrk22f120m/user_config.h" "${OUTPUTDIR}/../user_config.h"
cp -f "${ROOTDIR}/mqx/source/io/hwtimer/hwtimer_lpt.h" "${OUTPUTDIR}/hwtimer_lpt.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/twrk22f120m.h" "${OUTPUTDIR}/twrk22f120m.h"
cp -f "${ROOTDIR}/mqx/source/io/debug/iodebug.h" "${OUTPUTDIR}/iodebug.h"
cp -f "${ROOTDIR}/mqx/source/include/mqx.h" "${OUTPUTDIR}/mqx.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/bsp.h" "${OUTPUTDIR}/bsp.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/iar/intflash.icf" "${OUTPUTDIR}/intflash.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
mkdir -p "${OUTPUTDIR}/Generated_Code"
...
if [ "${TOOL}" = "uv4" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/uv4/intflash.scf" "${OUTPUTDIR}/intflash.scf"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk22f120m/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
