...
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\bsp_rev.h" "%OUTPUTDIR%\bsp_rev.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\PE_Types.h" "%OUTPUTDIR%\Generated_Code\PE_Types.h" /Y
copy "%ROOTDIR%\mqx\source\io\sai\int\sai_int_prv.h" "%OUTPUTDIR%\sai_int_prv.h" /Y
copy "%ROOTDIR%\config\k22fsh\user_config.h" "%OUTPUTDIR%\..\user_config.h" /Y
copy "%ROOTDIR%\mqx\source\io\hwtimer\hwtimer_lpt.h" "%OUTPUTDIR%\hwtimer_lpt.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\k22fsh.h" "%OUTPUTDIR%\k22fsh.h" /Y
copy "%ROOTDIR%\mqx\source\io\debug\iodebug.h" "%OUTPUTDIR%\iodebug.h" /Y
copy "%ROOTDIR%\mqx\source\include\mqx.h" "%OUTPUTDIR%\mqx.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\bsp.h" "%OUTPUTDIR%\bsp.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\PE_LDD.h" "%OUTPUTDIR%\Generated_Code\PE_LDD.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\init_lpm.h" "%OUTPUTDIR%\init_lpm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\bsp_cm.h" "%OUTPUTDIR%\bsp_cm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\iar\intflash.icf" "%OUTPUTDIR%\intflash.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\iar\ram.icf" "%OUTPUTDIR%\ram.icf" /Y
goto copy_end
...
IF NOT EXIST "%OUTPUTDIR%\Generated_Code" mkdir "%OUTPUTDIR%\Generated_Code"
IF NOT EXIST "%OUTPUTDIR%\Sources" mkdir "%OUTPUTDIR%\Sources"
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\uv4\intflash.scf" "%OUTPUTDIR%\intflash.scf" /Y
goto copy_end
...
IF NOT EXIST "%OUTPUTDIR%\Generated_Code" mkdir "%OUTPUTDIR%\Generated_Code"
IF NOT EXIST "%OUTPUTDIR%\Sources" mkdir "%OUTPUTDIR%\Sources"
copy "%ROOTDIR%\mqx\source\bsp\k22fsh\gcc_arm\intflash.ld" "%OUTPUTDIR%\intflash.ld" /Y
goto copy_end
