...
cp -f "${ROOTDIR}/mqx/source/bsp/lmq1/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/lmq1/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/lmq1/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/lmq1/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/lmq1/iar/intflash.icf" "${OUTPUTDIR}/intflash.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/lmq1/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
mkdir -p "${OUTPUTDIR}/Generated_Code"
...
if [ "${TOOL}" = "uv4" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/lmq1/uv4/intflash.scf" "${OUTPUTDIR}/intflash.scf"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/lmq1/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
