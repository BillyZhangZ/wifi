...
copy %MQXROOTDIR%\config\twrk21f120m\user_config.h %OUTPUTDIR%\..\user_config.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\sp140k22f\bsp.h %OUTPUTDIR%\bsp.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\sp140k22f\bsp_cm.h %OUTPUTDIR%\bsp_cm.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\sp140k22f\bsp_rev.h %OUTPUTDIR%\bsp_rev.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\sp140k22f\init_lpm.h %OUTPUTDIR%\init_lpm.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\sp140k22f\PE_LDD.h %OUTPUTDIR%\Generated_Code\PE_LDD.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\sp140k22f\sp140k22f.h %OUTPUTDIR%\sp140k22f.h /Y
...
copy %MQXROOTDIR%\mqx\source\io\adc\kadc\adc_mk21f.h %OUTPUTDIR%\adc_mk21f.h /Y
...
copy %MQXROOTDIR%\mqx\source\io\flashx\freescale\flash_mk21.h %OUTPUTDIR%\flash_mk21.h /Y
...
copy %MQXROOTDIR%\mqx\source\io\lwadc\lwadc.h %OUTPUTDIR%\lwadc.h /Y
copy %MQXROOTDIR%\mqx\source\io\lwadc\lwadc_kadc.h %OUTPUTDIR%\lwadc_kadc.h /Y
...
copy %MQXROOTDIR%\mqx\source\io\spi\spi_dspi_common.h %OUTPUTDIR%\spi_dspi_common.h /Y
...
IF NOT EXIST %OUTPUTDIR%\Generated_Code mkdir %OUTPUTDIR%\Generated_Code
for /R %MQXROOTDIR%\mqx\build\cw10\bsp_twrk21f120m\Generated_Code %%f in (*.h) do copy %%f %OUTPUTDIR%\Generated_Code\
IF NOT EXIST %OUTPUTDIR%\Sources mkdir %OUTPUTDIR%\Sources
for /R %MQXROOTDIR%\mqx\build\cw10\bsp_twrk21f120m\Sources %%f in (*.h) do copy %%f %OUTPUTDIR%\Sources\
copy %MQXROOTDIR%\mqx\source\bsp\twrk21f120m\cw\dbg\init_kinetis.tcl %OUTPUTDIR%\..\..\dbg\init_kinetis.tcl /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk21f120m\cw\dbg\mass_erase_kinetis.tcl %OUTPUTDIR%\..\..\dbg\mass_erase_kinetis.tcl /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk21f120m\cw\dbg\twrk21f120m.mem %OUTPUTDIR%\..\..\dbg\twrk21f120m.mem /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk21f120m\cw\intflash.lcf %OUTPUTDIR%\intflash.lcf /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk21f120m\cw\intram.lcf %OUTPUTDIR%\intram.lcf /Y
goto copy_end

rem iar files
:tool_iar
copy %MQXROOTDIR%\mqx\source\bsp\twrk21f120m\iar\intflash.icf %OUTPUTDIR%\intflash.icf /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk21f120m\iar\ram.icf %OUTPUTDIR%\ram.icf /Y
goto copy_end

rem cw10gcc files
:tool_cw10gcc
IF NOT EXIST %OUTPUTDIR%\Generated_Code mkdir %OUTPUTDIR%\Generated_Code
for /R %MQXROOTDIR%\mqx\build\cw10gcc\bsp_twrk21f120m\Generated_Code %%f in (*.h) do copy %%f %OUTPUTDIR%\Generated_Code\
IF NOT EXIST %OUTPUTDIR%\Sources mkdir %OUTPUTDIR%\Sources
for /R %MQXROOTDIR%\mqx\build\cw10gcc\bsp_twrk21f120m\Sources %%f in (*.h) do copy %%f %OUTPUTDIR%\Sources\
copy %MQXROOTDIR%\mqx\source\bsp\twrk21f120m\gcc_cw\intflash.ld %OUTPUTDIR%\intflash.ld /Y
goto copy_end

rem uv4 files
:tool_uv4
copy %MQXROOTDIR%\mqx\source\bsp\twrk21f120m\uv4\intflash.scf %OUTPUTDIR%\intflash.scf /Y
goto copy_end
