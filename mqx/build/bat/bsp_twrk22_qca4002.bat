...
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\bsp_rev.h" "%OUTPUTDIR%\bsp_rev.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\PE_Types.h" "%OUTPUTDIR%\Generated_Code\PE_Types.h" /Y
copy "%ROOTDIR%\mqx\source\io\sai\int\sai_int_prv.h" "%OUTPUTDIR%\sai_int_prv.h" /Y
copy "%ROOTDIR%\config\twrk22_qca4002\user_config.h" "%OUTPUTDIR%\..\user_config.h" /Y
copy "%ROOTDIR%\mqx\source\io\hwtimer\hwtimer_lpt.h" "%OUTPUTDIR%\hwtimer_lpt.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\twrk22_qca4002.h" "%OUTPUTDIR%\twrk22_qca4002.h" /Y
copy "%ROOTDIR%\mqx\source\io\debug\iodebug.h" "%OUTPUTDIR%\iodebug.h" /Y
copy "%ROOTDIR%\mqx\source\include\mqx.h" "%OUTPUTDIR%\mqx.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\bsp.h" "%OUTPUTDIR%\bsp.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\PE_LDD.h" "%OUTPUTDIR%\Generated_Code\PE_LDD.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\init_lpm.h" "%OUTPUTDIR%\init_lpm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\bsp_cm.h" "%OUTPUTDIR%\bsp_cm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\iar\intflash.icf" "%OUTPUTDIR%\intflash.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\iar\ram.icf" "%OUTPUTDIR%\ram.icf" /Y
goto copy_end
...
IF NOT EXIST "%OUTPUTDIR%\Generated_Code" mkdir "%OUTPUTDIR%\Generated_Code"
IF NOT EXIST "%OUTPUTDIR%\Sources" mkdir "%OUTPUTDIR%\Sources"
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\uv4\intflash.scf" "%OUTPUTDIR%\intflash.scf" /Y
goto copy_end
...
IF NOT EXIST "%OUTPUTDIR%\Generated_Code" mkdir "%OUTPUTDIR%\Generated_Code"
IF NOT EXIST "%OUTPUTDIR%\Sources" mkdir "%OUTPUTDIR%\Sources"
copy "%ROOTDIR%\mqx\source\bsp\twrk22_qca4002\gcc_arm\intflash.ld" "%OUTPUTDIR%\intflash.ld" /Y
goto copy_end
