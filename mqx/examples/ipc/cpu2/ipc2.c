...
#error This application requires BSPCFG_ENABLE_ITTYA defined non-zero in user_config.h. Please recompile libraries with this option.
#endif
...
#warning Please check that IO_PORT_NAME member of the pcb_mqxa_init structure below is set identically.
    ...
    #define DEFAULT_SERIAL_IPC_PORT_NAME "ittya:"
#endif
