...
COMPOSITE_HANDLE   g_app_handle;
static COMPOSITE_CONFIG_STRUCT composite_cfg[COMPOSITE_CFG_MAX] = {0};
...
void APP_init()
{
    COMPOSITE_CALLBACK_STRUCT usb_composite_callback;
    COMPOSITE_CONFIG_STRUCT vcom_config_callback;
    COMPOSITE_CONFIG_STRUCT disk_config_callback;
