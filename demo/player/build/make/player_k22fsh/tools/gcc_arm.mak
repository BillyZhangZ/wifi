...
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/debug/player/player.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/debug/audio/audio.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/debug/audio/codec_metadata.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/debug/audio/mp3dec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/debug/audio/flacdec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/debug/audio/apedec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/debug/audio/wavdec_lib.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/release/player/player.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/release/audio/audio.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/release/audio/codec_metadata.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/release/audio/mp3dec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/release/audio/flacdec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/release/audio/apedec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/k22fsh.gcc_arm/release/audio/wavdec_lib.a
endif
