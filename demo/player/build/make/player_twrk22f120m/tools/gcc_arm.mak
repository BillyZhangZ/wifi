...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/usb/usb.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/msi/msi.a
LIBRARIES += $(MQX_ROOTDIR)/externallibs/mfi/gcc/mfi.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/player/player.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/audio/audio.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/audio/codec_metadata.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/audio/mp3dec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/audio/flacdec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/audio/apedec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/audio/wavdec_lib.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/usb/usb.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/msi/msi.a
LIBRARIES += $(MQX_ROOTDIR)/externallibs/mfi/gcc/mfi.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/player/player.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/audio/audio.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/audio/codec_metadata.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/audio/mp3dec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/audio/flacdec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/audio/apedec_lib.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/audio/wavdec_lib.a
endif

LIBRARIES += $(MQX_ROOTDIR)/externallibs/bluetooth/gcc/bluetooth.a
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/debug/player
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk22f120m.gcc_arm/release/player
endif
